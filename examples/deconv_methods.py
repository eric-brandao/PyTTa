...
ht = pytta.ImpulsiveResponse(excitation = yt_split[1], recording = yt_split[0], 
                             samplingRate = xt.samplingRate, regularization = True,
                             freq_limits = [100, 10000], method = 'linear')

#%% Testing methods
ht_naive = ht._naive_deconv(yt_split[1], yt_split[0])
ht_regu = ht._regularized_deconv(yt_split[1], yt_split[0], freq_limits = [100, 10000])
ht_regu_zp = ht._regularized_zp_deconv(yt_split[1], yt_split[0], freq_limits = [100, 10000], num_zeros = None)
# ht_welch_h1 = ht._welch_h1_deconv(yt_split[1], yt_split[0],winType = 'hann', 
#                      winSize = 2**16, overlap = 0.6)
ht_invfilter = ht._deconv_invfilter(yt_split[1], yt_split[0], freq_limits = [100, 10000])
